...
<head>
    ...
    <title>Gestión Tipos Conexión</title>
...
<body>
        ...
        <section id="middle">
            ...
            <header id="page-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active"> / Tipos Conexión</li>
                </ol>
            </header>
            <!-- /page title -->
                ...
                <div class="table-responsive" style="width: 190%;">
                    <div class="table-wrapper">
                        <div class="table-title">
                            <div class="row">
                                <div class="col-sm-6">
                                    <h2 style="color:white">Gestionar <b>Tipos Conexión</b></h2>
                                </div>
                                <div class="col">
                                    <a href='#addConexionModal' class="btn btn-success" data-toggle='modal'><i class="material-icons">&#xE147;</i> <span>Añadir Nueva Conexión</span></a>
                                </div>
                            </div>
                        </div>
                        <table id="dt_conexion" class="table table-striped table-hover">
                            <thead>
                                <tr>
                                    <th>Nombre</th>
                                    <th>Acción</th>
            ...
            <!-- Add Conexión HTML -->
            <div id="addConexionModal" class="modal fade">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <form id="addConexion">
                            <div class="modal-header">
                                <h4 class="modal-title">Añadir Conexión</h4>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group" style="display: none;">
                                    <input type="text" class="form-control" name="action" value="insertConexion">
            ...
            <!-- Edit Conexion HTML -->
            <div id="editConexionModal" class="modal fade">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <form id="editConexion">
                            <div class="modal-header">
                                <h4 class="modal-title">Modificar Conexión</h4>
                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                            </div>
                            <div class="modal-body">
                                <div class="form-group">
                                ...
                                <div class="form-group" style="display: none;">
                                    <input id="editAction" type="text" class="form-control" name="action" value="updateConexion">
            ...
            <div id="deleteConexionModal" class="modal fade">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <form id="deleteConexion">
                            <div class="modal-header">
                                <h4 class="modal-title">Eliminar Conexión</h4>
                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                            </div>
                            <div class="modal-body">
                                <p>Estás seguro de eliminar a esta conexión?</p>
                                <p class="text-warning"><small>Esta acción no se puede revertir</small></p>
                                <div class="form-group" style="display: none;">
                                    <input type="text" class="form-control" name="action" value="deleteConexion">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            // POST
            $('#addConexion').on('submit', function(e) {
                e.preventDefault();
                var formData = new FormData($('#addConexion')[0]);
                $.ajax({
            ...
            $('#editConexion').on('submit', function(e) {
                e.preventDefault();
                var formData = new FormData($('#editConexion')[0]);
                $.ajax({
                    url: 'postCrudConexElec.php',
                    type: 'POST',
                    data: formData,
            ...
            $('#deleteConexion').on('submit', function(e) {
                e.preventDefault();
                var formData = new FormData($('#deleteConexion')[0]);
                $.ajax({
                    url: 'postCrudConexElec.php',
                    type: 'POST',
                    data: formData,
            ...
            // TBODY
            $('#dt_conexion tbody').on('click', 'tr', function() {
                arrayData = $('#dt_conexion').DataTable().row(this).data();
                $('#editNombre').prop('value', arrayData[0]);
                $('#editNombreAntiguo').prop('value', arrayData[0]);
                $('#deleteNombre').prop('value', arrayData[0]);
            });

            loadConexiones(plataforma);
        });

        var loadConexiones = function(plataforma) {
            $.ajax({
                type: 'GET',
                url: 'api_datos.php',
                ...
                success: function(data) {
                    ...
                    $("#dt_conexion").dataTable().fnDestroy();
                    definirDataTable("#dt_conexion");
        ...
        var populateDataTable = function(data) {
            ...
            $("#dt_conexion").DataTable().clear();
            var length = Object.keys(data).length;
            for (var i = 0; i < length; i++) {
                var res = data[i];

                // Se puede cargar la info desde la inicializacion de la tabla
                $('#dt_conexion').dataTable().fnAddData([
                    res.nombre,
                    "<a href='#editConexionModal' class='edit' data-toggle='modal'><i class='material-icons' data-toggle='tooltip' title='Modificar'>&#xE254;</i></a><a href='#deleteConexionModal' class='delete' data-toggle='modal'><i class='material-icons' data-toggle='tooltip' title='Eliminar'>&#xE872;</i></a>"
                ]);
