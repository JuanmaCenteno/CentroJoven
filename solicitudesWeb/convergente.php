...
<body>
    ...
    <header>
        <?php if (!isset($_SESSION['MASTER'])) { ?>
            ...
            <p style="float: right; margin-right: 15%;"><strong>¿Te ayudamos? Llama al 722 774 556</strong></p>
            ...
            <div class="col mt-3" style="margin-left: 15%; height: 100%;">
                <form id="formData" class="mt-4">
                    <ul class="nav nav-tabs" id="myTabs" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="configurar-tab" href="#tabConfigurar" data-toggle="tab" role="tab" aria-controls="profile" aria-selected="false">Configurar</a>
                        </li>
                        <li class="nav-item">
