...
$query = "SELECT t.ID as id, NOMBRE_PUBLICO as nombre, PVP as pvp FROM multiplataforma.tarifas_masmovil_reseller t INNER JOIN multiplataforma.tarifas_masmovil_reseller_precios p ON p.ID_TARIFA = t.ID WHERE t.ID = ?";
...
<body>
    ...
    <div class="container-full">
        <!-- Steps Guide 
        <div class="row-4" style="background: linear-gradient(to bottom, #cc3366 0%, #ffaed5 100%); height: 100px;">
            ...
            <div class="col mt-3" style="margin-left: 15%; height: 100%;">
                <form id="formData" class="mt-4">
                    <ul class="nav nav-tabs" id="myTabs" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="datos-tab" href="#tabDatos" role="tab" aria-controls="home" aria-selected="true">Datos del Titular</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <div class="tab-content mt-4">
                        <!-- Tab Datos -->
                        <div class="tab-pane active" id="tabDatos" role="tabpanel" aria-labelledby="datos-tab">
                            ...
                            <div id="contenedorCif" class="oculto hidden mt-4">
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6 col-12">
                                        ...
                                        <input type="text" class="form-control" id="dniAdministrador" name="dniAdministrador" placeholder="DNI Administrador">
                                        <label id="labelDniAdministrador" class="errorMsg">Introduce un DNI válido</label>
                                    </div>
                                </div>
                            </div>
                            <div class="row mt-4">
                            ...
                            <!-- Teléfono Fijo Mininet -->
                            <?php if (intval($tarifa) == 14396) { ?>
                                <div class="row mt-2">
                                    <div class="form-group col-md-6 col-12">
                                        <label for="numeroFijoMininet">Teléfono de fibra*</label>
                                        <input type="number" class="form-control numericInput" id="numeroFijoMininet" name="numeroFijoMininet" placeholder="Teléfono fijo de fibra*" max="9">
                                        <span id="labelMininet" class="errorMsg">El número fijo no está registrado en Netvoz. Póngase en contacto con nosotros a través de solicitudes@netvoz.eu</span>
                                        <span id="labelFijo" class="errorMsg">Introduce un número fijo válido</span>
                                    </div>
                                </div>
                            <?php } ?>
                            <!-- Email -->
                        ...
                        <div class="tab-pane" id="tabConfigurar" role="tabpanel" aria-labelledby="configurar-tab">
                            ...
                            <div class="form_module hidden mt-3" style="display: block;">
                                <h4>Tu móvil principal </h4>
                                <!-- Conservar Móvil Activar -->
                                <div class="row row-custom-radios">
                                    <div class="col-md-12">
                                        <label>¿Quieres conservar tu número móvil actual en Netvoz?</label>
                                    </div>
                                ...
                                <div class="textIndentProduct mt-3">
                                    <div id="mobilePortinPhoneNumber" class="hidden" style="display: block;">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="oculto form-group col-12 col-md-6" id="divMovil">
                                                <label for="numeroTelefonoNuevo">Introduce el número móvil que quieres traer a Netvoz</label>
                                    ...
                                    <div id="modalityButtons" class="hidden" style="display: block;">
                                        <!-- Modalidad -->
                                        <div class="row">
                                            <div class="row form-group col-12 oculto" id="divModalidad">
                                                <div class="row ml-3">
                                            ...
                                            <!-- ICC -->
                                            <div class="row oculto ml-0" id="divIcc">
                                    ...
                                    <div id="divSelectTitular" class="oculto mt-2">
                                        <div class="row row-custom-radios">
                                            ...
                                            <div class="custom-control custom-radio col-12 ml-4">
                                                <input type="radio" id="comprobarTitularSi" name="comprobarTitular" class="custom-control-input" disabled="true">
                                                <label class="custom-control-label" for="comprobarTitularSi">Sí, soy el titular </label>
                                            </div>
                                            <div class="custom-control custom-radio col-12 ml-4">
                                                <input type="radio" id="comprobarTitularNo" name="comprobarTitular" class="custom-control-input" disabled="true">
                        ...
                        <div class="tab-pane" id="tabPaga" role="tabpanel" aria-labelledby="pago-tab">
                            ...
                            <div class="row col-12">
                                ...
                                <div class="form-group col-md-2 col-6">
                                    ...
                                    <input type="text" class="form-control numericInput" id="accountEntity" name="entidadCuentaBancaria" maxlength="4" format-validation="accountNumber" target-office-id="accountOffice" target-dc-id="accountDC" target-account-id="accountAccountNumber" target-code-id="accountCode">
                                </div>
                                <div class="form-group col-md-2 col-6">
                                ...
                                <div class="form-group col-md-2">
                                    <input type="text" class="form-control numericInput" id="numCuenta3" name="numCuenta3" maxlength="4" style="width: 95%; margin-top: 24%;">
                                </div>
                            ...
                            <div class="form_module mt-4">
                                <h3 style="display: block;">Elige tu SIM - Línea principal</h3>
                                <div class="mt-3">
                                    <label>Te enviaremos una SIM de triple corte, válida para cualquier modelo de móvil. </label>
                                    <div class="row">
                                        <div class="row form-group col-12">
                                            <div class="col-12 " style="display: block;">
                                                <div class="container">
                                                    <!-- Datos Dirección de Envío SIM -->
                                                    <div id="divDatosDireccion">
                                                        <div class="row">
                                                            <div class="form-group col-md-4">
                                                                <label>CP*</label>
                                                                <input type="text" class="form-control numericInput" maxlength="5" id="codigoPostal" name="codigoPostal">
                                                        ...
                                                        <div class="row">
                                                            <div class="form-group col-md-8 disabled">
                                                                ...
                                                                <input type="text" class="initial_inputs form-control col-md-12" disabled="disabled" id="nombreCalle" name="nombreCalle">
                                                        ...
                                                        <div class="row">
                                                            <div class="form-group col-md-8 disabled">
                                                                ...
                                                                <input type="text" class="initial_inputs form-control col-md-12" disabled="disabled" id="municipio" name="municipio">
                                                        ...
                                                        <div class="row">
                                                            <div class="form-group col-md-8 disabled">
                                                                ...
                                                                <input type="text" class="initial_inputs form-control col-md-12" disabled="disabled" id="provincia" name="provincia">
                                                                <div class="invalid-feedback">Escribe el nombre de la calle sin tipo de vía.</div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="form-group col-md-8">
                                                                <div class="row">
                                                                    <div class="form-group col-md-4">
                                                                        <label>Número*</label>
                                                                        <input type="text" class="numericAndSNinput initial_inputs form-control" id="numeroCalle" name="numeroCalle" disabled="disabled">
                                                                    ...
                                                                    <div class="form-group col-md-8">
                                                                        <div class="custom-control custom-checkbox">
                                                                            <input type="checkbox" class="custom-control-input" disabled="disabled" id="checkSinNumero">
                                                                            <label class="custom-control-label" for="checkSinNumero">Sin número</label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group align-self-end">
                                                                    <input type="button" id="btnValidarDireccion" class="btn btn-success w-25" disabled="" value="Validar">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div id="divBotonElegirDireccion" class="mt-4">
                                                        <button type="button" id="btnElegirOtraDireccion" class="form-group btn btn-secondary btn-sm text-left">Elegir otra dirección</button>
                                                    </div>
                                                    <!-- Info Extra Dirección -->
                                                    <div id="divCompletarDireccion" class="oculto">
                                                        <p>Completa tu dirección, solo si es necesario</p>
                                                        <div class="row">
                                                            <div class="form-group col-md-3 col-12">
                                                                <label>Planta</label>
                                                                <input type="text" id="plantaCalle" name="plantaCalle" class="form-control">
                                                            </div>
                                                            <div class="form-group col-md-3 col-12">
                                                                <label>Puerta</label>
                                                                <input type="text" id="puertaCalle" name="puertaCalle" class="form-control">
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="form-group col-md-3 col-12">
                                                                <label>Bloque</label>
                                                                <input type="text" class="form-control" id="bloqueCalle" name="bloqueCalle">
                                                            </div>
                                                            <div class="form-group col-md-3 col-12">
                                                                <label>Escalera</label>
                                                                <input type="text" class="form-control" id="escaleraCalle" name="escaleraCalle">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="form_module gradient_shadow">
                                    ...
                                    <div class="row">
                                        <div class="row form-group col-12">
                                            ...
                                            <div class="custom-radio-button col-md-4 hidden ml-3 mt-3" style="display: block;">
                                                <input type="button" class="btn w-75" style="background-color: lightskyblue; font-weight: bold;" id="btnDireccionSim" value="Dirección de SIM">
                                            </div>
                                            ...
                                            <label class="oculto col-12 mt-4 ml-3" id="labelInfoDireccion">Misma dirección que envío de SIM</label>
                                            <div class="col-12">
                    ...
                    <input type="text" id="idEmpresa" name="idEmp" value="<?php echo $idEmp; ?>" style="display: none;">
                    <input type="text" id="idTarifa" name="idTarifa" value="<?php echo $idTarifa; ?>" style="display: none;">
                    <input type="text" id="nombreTarifa" name="nombreTarifa" value="<?php echo $nombre; ?>" style="display: none;">
                    <input type="text" id="precioTarifa" name="precioTarifa" value="<?php echo $precio; ?>" style="display: none;">
                    <input type="text" name="plataforma" value="MOVIL" style="display: none;">
                </form>
            </div>
            <!-- Cart View -->
                ...
                <div id="cart_view" class="container_blue mt-2" style="display: block;">
                            ...
                            <div class="container pl-0 pr-0">
                                <div id="currentPackCart" class="row cartElement hidden" style="display: block;">
                                    <div class="col-12">
                                        ...
                                        <?php if ($idEmp != "") { ?>
                                            <select id="selectTarifa" class="selectpicker" title="Selecciona una tarifa" data-live-search="true"></select>
                                            </br></br>
                                        <?php } ?>
                                        <span id="spanNombreTarifa" class="cart_element_msg packSelectedData mt-3"><?php echo $nombre; ?></span>
                                    </div>
                                </div>
                                <div id="instalationAddressCart" class="row cartElement hidden" style="display: none;">
                                    <div class="col-12">
                                        <span class="cart_element_title">Dirección de instalación</span>
                                        <span class="cart_element_msg"></span>
                                    </div>
                    ...
                    <div id="cart_footer" class="container cart_footer hidden" style="display: block;">
                        ...
                        <div class="row mt-3 ml-0">
                            <h2 id="spanPrecio" class="price_rate"><?php echo $precio; ?>€</h2>
                        </div>
                        <hr />
                    </div>
                </div>
    ...
    <script type="text/javascript" src="solicitudesWeb/js/movil.js"></script>
</body>
